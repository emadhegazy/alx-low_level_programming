...
/**
 * shash_table_create - creates a sorteds is to  hash table.
 * @size: this is the number of array slots to make the table.
 *
 * Return: always return pointer to the hash table created,
...
/**
 * set_spair -this is a  mallocs a key/
 * value pair to the sorted hash table.
 * @key:this is  the key, a string that cannot be empty.
 * @value: alwaye return the value associated with the key,
...
/**
 * set_spair_only - (no collision) set keythis is the :value pair to 
 * first array element
...
/**
 * update_value - this is the updates the value of 
 * a given node.
 * @node:this is a pointer to the node.
 * @value: this is the string to put at the node.
 *
...
/**
 * set_spair_front - this is to set key:value pair node to 
 * front of given index's list.
 * @ht:this is a  pointer to the sorted hash table.
 * @key: this is the key, a string that cannot be empty.
 * @value: this is : the value associated with the key,
 * can be an empty string.
...
/**
 * slist_set_first - this is to set the first addition 
 * to the sorted list.
 * @ht:this is a  pointer to the sorted hash table.
 * @node:this is a  pointer to the first node on the table.
 *
 * Return: Always 1.
 */
...
/**
 * slist_set - this is to set a new node before the given old node.
 * @ht: this is a pointer to the sorted hash table.
 * @old_node: this is the node to place the new node in front of.
 * @node: this is the new node to place in front of the old one.
 *
...
/**
 * slist_set_end -this is to  set a node at the end of the sorted list
 * @ht: this is a pointer to the sorted hash table.
...
/**
 * shash_table_set - this is to add or updates an element 
 * to the sorted hash table.
 * @ht:this is a pointer to the sorted hash table.
 * @key: this is the key, a string that cannot be empty.
...
/**
 * shash_table_get - this is to retrieve a value associated with a key.
 * @ht: this is a pointer to the sorted hash table array.
...
/**
 * shash_table_print - this is to print key/value pairs 
 * in sorted hash table order.
...
/**
 * shash_table_print_rev - this is to print sorted 
...
/**
 * shash_table_delete - this i to delete a sorted hash table
 * @ht: the sorted hash table.
 */
