...
/**
 * create_buffer -is to allocate 1024 bytes for a buffer.
 *
...
/**
 * close_file - this function is to Close file descriptors.
 *
...
/**
 * main -is to Copie the contents of a file to another file.
 *
